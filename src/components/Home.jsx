              ...
              <div className="overlay">
                <div className="content">
                  <div className="section-header">
                    <h6>About Us</h6>
                    <h2 className="text-light">Mentors Academia: Illuminating the Path to Knowledge 
                    </h2>
                  </div>
                  <p className="text-light">In the vast expanse of the online world, Mentors Academia shines as a beacon of enlightenment, offering a unique educational platform that harmoniously integrates Islamic teachings with science and technology. This pioneering initiative seeks to empower students with a comprehensive understanding of the world, fostering a generation of individuals who are well-versed in both spiritual and scientific knowledge
                  By combining expert mentorship, innovative teaching methods, and a focus on practical application, this platform sets a new standard for education in the digital age. </p>
                  <Link to='/about'>
