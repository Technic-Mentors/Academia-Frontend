      ...
      <div className="container-xxl py-4 bg-white">
        <div className="container">
          ...
          <div className="row g-4">
            {allTeacher &&
              allTeacher
                .filter((teacher) => teacher.status === "Approved").reverse().filter(teacher => teacher.name.toLowerCase().includes(searchName.toLowerCase())).filter(teacher =>  teacher.email.toLowerCase().includes(searchEmail.toLowerCase()))
                .map((teacher) => {
                  return (
                    <div
